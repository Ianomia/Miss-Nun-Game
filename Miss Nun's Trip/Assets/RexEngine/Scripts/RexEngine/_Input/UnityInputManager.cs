...
namespace RexEngine
{
    public class UnityInputManager:InputManager
    {
		...
		public bool allowQueryOfGameManager = true;
        ...
        protected override void Awake()
        {
			...
			if((allowQueryOfGameManager && GameManager.Instance.settings.numberOfPlayers > 1) || usePrefix)
			{
				playerAxisPrefix = "Player";
			}

			maxNumberOfPlayers = (allowQueryOfGameManager) ? GameManager.Instance.settings.numberOfPlayers : 1;
