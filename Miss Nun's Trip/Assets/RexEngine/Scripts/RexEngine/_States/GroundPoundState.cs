...
namespace RexEngine
{
	public class GroundPoundState:RexState 
	{
		...
		public bool retainHorizontalAcceleration = false;
		...
		public override void UpdateMovement()
		{
			...
			{
				if(controller.slots.physicsObject.IsOnSurface() || hasLanded)
				{
					hasLanded = true;
		...
		public override void OnBegin()
		{
			...
			if(!canMoveHorizontally && !retainHorizontalAcceleration)
			{
				controller.slots.physicsObject.SetAccelerationCapX(0.0f);
			}
