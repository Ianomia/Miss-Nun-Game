	...
	void OnGUI()
	{
		...
		if(showFieldTemplate)
		{
			...
			if(GUILayout.Button("Enemy"))
			{
				...
				PrefabUtility.UnpackPrefabInstance(_gameObject, PrefabUnpackMode.Completely, InteractionMode.AutomatedAction);
#else
...
PrefabUtility.UnpackPrefabInstance(_gameObject, PrefabUnpackMode.Completely, InteractionMode.AutomatedAction);
		...
		if(showFieldGimmicks)
		{
			...
			if(GUILayout.Button("Moving Platform (Circular)"))
			{
				CreateAtPath("Gimmicks/CircularMovingPlatform");
			}
			...
			{
				CreateAtPath("Gimmicks/PushableBlock");
			}

			if(GUILayout.Button("Spring"))
			{
				CreateAtPath("Gimmicks/Spring");
			}
			...
			if(GUILayout.Button("Switch Button"))
			{
				CreateAtPath("Gimmicks/SwitchButton");
			}
		...
		if(showFieldPowerups)
		{
			...
			{
				CreateAtPath("Powerups/EnableAttackPowerup");
			}
