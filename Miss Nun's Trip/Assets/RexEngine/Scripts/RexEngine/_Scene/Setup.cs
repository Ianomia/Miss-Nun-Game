...
namespace RexEngine
{
	public class Setup:MonoBehaviour 
	{
		void Awake()
		{
			...
			{
				GameObject prefab = (ProjectSettingsAsset.Instance.rexSettingsData.cameraSettings.camerasObject) != null ? ProjectSettingsAsset.Instance.rexSettingsData.cameraSettings.camerasObject : Resources.Load("System/Cameras") as GameObject;
				GameObject newObject = Instantiate(prefab).gameObject;
