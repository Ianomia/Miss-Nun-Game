...
public class ScreenFade:MonoBehaviour 
{
	...
	void Update()
	{
		...
		{
			currentFadeLerp += Time.deltaTime / currentFadeDuration;
			textureAlpha = Mathf.Lerp(startingAlpha, targetTextureAlpha, currentFadeLerp);
